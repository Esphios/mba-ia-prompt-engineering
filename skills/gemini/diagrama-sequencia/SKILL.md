...
description: Analisa um metodo ou fluxo para mapear callers e callees, rastrear o caminho completo desde o ponto de entrada ate persistencia ou integracoes, e gerar diagramas de sequencia Mermaid detalhados. Use quando Gemini precisar entender fluxos de negocio, pontos de transformacao de dados ou impacto de mudancas.
---
