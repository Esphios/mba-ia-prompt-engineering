...
- `Display name`: `Create AGENTS.md`
- `Short description`: `Generate or improve repository instruction files`
- `Suggested prompt`: `Use $create-agentsmd to create or improve the repository instruction file for this project.`
