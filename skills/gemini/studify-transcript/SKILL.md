...
description: Transform rough lecture transcripts, class notes, or OCR-derived academic text into study-ready Markdown with clearer structure, preserved meaning, selective deduplication, and optional tables or Mermaid diagrams. Use when Gemini needs to reorganize one or more lecture transcriptions into a cleaner document for review, revision, memorization, or teaching support without discarding relevant content.
---
...
- `Display name`: `Studify Transcript`
- `Short description`: `Organize lecture transcripts for study`
- `Suggested prompt`: `Use $studify-transcript to turn this class transcript into study-ready Markdown.`
...
When using this skill, instruct Gemini to:
