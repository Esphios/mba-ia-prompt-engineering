...
Os conceitos discutidos abaixo são acompanhados por scripts em `examples/`:

- `1-bugfix-scope.py`
- `2-system-user-separation.py`
- `3-prompt-structure-template.py`
- `4-zero-shot-vs-few-shot.py`
- `5-cost-latency-quality.py`

Esses exemplos servem para visualizar a diferença entre prompt ambíguo e prompt estruturado, separar `System Prompt` de `User Prompt`, comparar zero-shot com few-shot e tornar mais concreto o trade-off entre custo, latência e qualidade.
...
Veja também: `examples/1-bugfix-scope.py`.
...
Veja também: `examples/5-cost-latency-quality.py`.
...
Veja também: `examples/4-zero-shot-vs-few-shot.py`.
...
Veja também: `examples/2-system-user-separation.py`.
...
Veja também: `examples/3-prompt-structure-template.py`.
